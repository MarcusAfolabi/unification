...
<div class="main_content">
    <div
        ...
        <div class="text-center max-w-xl mx-auto z-10 relative px-5">
            <div class="lg:text-4xl text-2xl text-white font-semibold mb-3">  SUBCONVENTION 2023 </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-y-7 md:gap-x-6 gap-6"> 
                <div class="md:col-span-2 md:flex items-center justify-between">
                    <a href="https://flutterwave.com/pay/graduate_student"
                        class="button hover:bg-white bg-green-700 w-full md:w-auto md:mt-0 mt-4">
                        Graduate N4,000</a>

                    <a href="https://flutterwave.com/pay/students_payment"
                        class="button hover:bg-white bg-dark-700 w-full md:w-auto md:mt-0 mt-4">Undergraduate N2,500
                    </a>
                </div>
            </div> 
        </div> 

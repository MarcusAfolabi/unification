                            ...
                            <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                <div class="overflow-x-auto">
                                    <table class="min-w-full">
                                        <thead class="border-b bg-gray-50 dark:bg-white">
                                            <tr>
                                                <th scope="col"
                                                    class="text-sm dark:text-white font-medium text-gray-900 px-6 py-4 text-left">
                                                    S/No</th>
                                                <th scope="col"
                                            ...
                                            @foreach ($conventions as $key => $convention)
                                                <tr class="border-b">
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="{{ route('convention.show', $convention) }}"
                                                            target="_blank">
                                                            {{ $convention->lastname }} {{ $convention->middlename }}
                                                            {{ $convention->firstname }} </a>
                                                    </td>
                                                    <td
                                                        class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">

                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td
                                            ...
                                            $convention->middlename }}
                                        </td>
                                        <td
                                        class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                        {{ $convention->yourFellowship }}
                                    </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                            {{ $convention->academicStatus }} | {{
                                            $convention->unificationCurrentPost }} | {{
                                            $convention->unificationStatus }}
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                            {{ $convention->positionHeld }}
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                            {{ $convention->graduationYear }}
                                        </td>
                                        <td
                                            class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                            {{ $convention->phoneNumber }}
                                        </td>
                                        <td
                                        class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                        {{ $convention->email }}

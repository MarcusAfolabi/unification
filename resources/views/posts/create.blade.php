@extends('layouts.main')@section('title', 'Add Post')@section('description', 'You can add event and fellowship activities from here') @section('main') <div class="main_content">

            ...
            <div class="header_search"><i class="uil-search-alt"></i>
                <form action="">
                    <input type="text" class="form-control" name="search"
                        placeholder="Search by product name, categories.." autocomplete="off">
                </form>
            </div>
            <hr>
            <br>
                            ...
                            <table class="min-w-full border-collapse border border-slate-400">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-white border-b">
                                        ...
                                        <td
                                            class="text-sm text-gray-900 font-light px-1 py-1 whitespace-nowrap border border-slate-300">
                                            <a uk-tooltip="Edit Product" href="{{route('house.edit', $house) }}"> <span
                                        ...
                                        <td
                                            ...
                                            <form action="{{ route('house.destroy', $house) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                                <button type="submit" uk-tooltip="Delete Product"
        ...
        <div id="modal-example" uk-modal>
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Add House</h2>
                </div>

        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li class="{{ Request::routeIs('books.index') ? 'active' : '' }}"><a href="{{ route('books.index') }}">
                            <svg height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve">
                                <g>
                            ...
                            </svg><span> Book Store </span></a>
                    </li>
                    <li class="{{ Request::routeIs('fellowship.index') ? 'active' : '' }}"><a href="{{ route('fellowship.index') }}">
                    <svg width="800px" height="800px" viewBox="-40.61 0 538.137 538.137" xmlns="http://www.w3.org/2000/svg">

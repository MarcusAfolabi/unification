                ...
                <div class="p-10 space-y-7">
                    <div class="line">
                        <input class="line__input" id="greeting" name="greeting" type="text"
                            onkeyup="this.setAttribute('value', this.value);" value="{{ old('greeting') }}" autocomplete="off">
                    ...
                    <div class="line">
                        <input class="line__input" id="actiontext" name="actiontext" type="text"
                            onkeyup="this.setAttribute('value', this.value);" value="{{ old('actiontext') }}" autocomplete="off">
                    ...
                    <div class="line">
                        <input class="line__input" id="footer" name="footer" type="text"
                            onkeyup="this.setAttribute('value', this.value);" value="{{ old('footer') }}" autocomplete="off">

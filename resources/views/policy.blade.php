            ...
            <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                <div class="section">
                    ...
                    <div class="blog-post-text">
                        ...
                        <p>Effective date: October 12, 2019</p>
        
        
                        <p>Isokan Campus Stories ("us", "we", or "our") operates the https://isokancampusstories.org/ website
                            (the "Service").</p>
                        ...
                        <p>We use your data to provide and improve the Service. By using the Service, you agree to the
                            ...
                            Conditions, accessible from <a href="https://isokancampusstories.org">
                                https://isokancampusstories.org/</a></p>
                        ...
                        <p>Isokan Campus Stories uses the collected data for various purposes:</p>
                        <ul>
                        ...
                        <p>If you are located outside Nigeria and choose to provide information to us, please note that we
                        ...
                        <p>Isokan Campus Stories will take all steps reasonably necessary to ensure that your data is treated
                        ...
                        <p>Isokan Campus Stories may disclose your Personal Data in the good faith belief that such action is
                            necessary to:</p>
                        <ul>
                            <li>To comply with a legal obligation</li>
                            <li>To protect and defend the rights or property of Isokan Campus Stories</li>
                        ...
                        <ul>
                            <li>
                                ...
                                <p>Google is a web analytics service. Read the Privacy Policy for Clicky here: <a
                                        href="https://google.com/analytics">https://google.com/analytics</a></p>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>By email: <a href="mailto:info@cnsunification.org">info@cnsunification.org</a> </li>

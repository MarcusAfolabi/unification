        ...
        <div class="card">
                    ...
                    <div class="profiles_content">
                        ...
                        <div class="profile_info">
                            ...
                            <p> {{ auth()->user()->positionHeld }}, {{ auth()->user()->unit_in_fellowship }}, <a
                                    href="{{ route('profile.show') }}"> <span class="uil-edit-alt mr-1"></span> </a></p>
                        </div>
                ...
                <div class="uk-switcher lg:mt-8 mt-4" id="timeline-tab">
                    ...
                    <div class="md:flex md:space-x-6 lg:mx-16">
                       ...
                       <a href="{{ route('posts.create') }}" class="bg-white font-semibold my-3 px-6 py-2 rounded-full shadow-md dark:bg-gray-800 dark:text-white">
                        ...
                        <div class="w-full space-y-6">
                            ...
                            <div class="widget card p-5">
                                ...
                                <ul class="text-gray-600 space-y-3 mt-3">
                                    ...
                                    <li class="flex items-center space-x-2">
                                        <span class="icon-feather-bookmark"></span>{{ auth()->user()->qualification_one }}
                                    </li>
                                    <li class="flex items-center space-x-2">
                                    ...
                                    <li class="flex items-center space-x-2">
                                        <span class="icon-feather-bookmark"></span>{{ auth()->user()->qualification_two }}
                                    </li>
                                    <li class="flex items-center space-x-2">
                                        <span class="icon-feather-bookmark"></span>
                                    ...
                                    <li class="flex items-center space-x-2">
                                        <span class="icon-feather-bookmark"></span>{{ auth()->user()->qualification_three }}
                                    </li>
                                    <li class="flex items-center space-x-2">
                                        <span class="icon-feather-bookmark"></span>

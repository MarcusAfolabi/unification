            ...
            <div class="profiles_content">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex items-center -space-x-4">
                        ...
                        <img src="{{ asset($fellowship_user->profile_photo_path) }}" alt="{{$fellowship_user->name}}" uk-tooltip="{{$fellowship_user->name}} {{$fellowship_user->lastname}}" class="w-10 h-10 rounded-full border-2 border-white">
                        @endforeach
                        <div class="w-10 h-10 rounded-full flex justify-center items-center bg-red-100 text-red-500 font-semibold"> {{ $fellowship_member }}+
                        </div>
                    </div>
                </div>
                ...
                <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                    <div class="flex justify-between items-center lg:p-4 p-2.5">
                        <div class="flex flex-1 items-center space-x-4">
                            <a href="#">
                                <img src="{{ asset($fellowship_post->user->profile_photo_path) }}" uk-tooltip="{{$fellowship_post->user->name}}" class="bg-gray-200 border border-white rounded-full w-10 h-10">
                            </a>
                            <div class="flex-1 font-semibold capitalize">
                                <a href="#" class="text-black dark:text-gray-100"> {{$fellowship_post->user->name}} {{$fellowship_post->user->lastname}} </a>
                                <div class="text-gray-700 flex items-center space-x-2"> {{$fellowship_post->created_at->diffForHumans()}}<span> </span> <ion-icon name="people"></ion-icon></div>
                            </div>
                        </div>
                    </div>

                    <!-- <div uk-lightbox>
                                <a href="{{ asset($fellowship_post->image) }}">  
                ...
                <div class="card p-5 mb-5">
                    ...
                    <div class="space-y-4 mt-3">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <div class="font-semibold"> {{ $fellowship_member }} members in this fellowship </div>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">

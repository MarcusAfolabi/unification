...
Once we have received confirmation of your payment, we will enable  link to download your ID in your dashboard and all the necessary information you need to access the convention platform.
...
Cherubim and Seraphim Church Unification Campus Fellowship Convention 2023 Organizing Team<br>
{{ config('app.name') }}
@endcomponent

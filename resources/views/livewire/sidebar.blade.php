                ...
                <ul>
                    @guest
                        ...
                        @auth @if (auth()->user()->role === 'admin')
                            ...
                            <li><a wire:navigate.hover href="{{ route('resource.index') }}"><svg height="800px" width="800px" version="1.1"
                                        id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
                                        xml:space="preserve">
                                        <path style="fill:#9BC9FF;"
                            ...
                            <li class="{{ Request::routeIs('fellowship.index') ? 'active' : '' }}"><a
                                    wire:navigate.hover href="{{ route('fellowship.index') }}"><svg width="800px" height="800px"

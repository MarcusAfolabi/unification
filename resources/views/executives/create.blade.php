...
@section('title', 'List New Central Executives Council')
            ...
            <div class="mcontainer">
                ...
                <div class="breadcrumb-area py-0">
                    <div class="breadcrumb">
                        <ul class="m-0">
                            ...
                            <li class="active">
                                <a href="{{ route('executives.create') }}">Add New</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">
                    ...
                    <div class="py-4 border-b flex  justify-between px-6">
                        <h3 class="text-lg font-semibold"> List New Executives </h3>
                        <div>
                        ...
                        <div class="p-10 space-y-7">
                            ...
                            <div class="line">
                                <input class="line__input" id="hobby" name="hobby" type="text"
                                    onkeyup="this.setAttribute('value', this.value);" value="{{ old('hobby') }}"
                                    autocomplete="off">
        ...
        <div class="main_content">
            <div class="mcontainer">
                <div class="border-t flex justify-between lg:space-x-10 p-7 bg-gray-50 rounded-b-md">
                    ...
                    <button class="button dark" type="submit"> You are not authorised to perform this operation. Contact
                        Admin</button>
                </div>
            </div>
        </div>

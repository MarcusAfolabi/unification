 <div class="sidebar_inner" data-simplebar>
     <ul>
         ...
         <li class="{{ Request::routeIs('subconvention') ? 'active' : '' }}"><a
                 wire:navigate.hover href="{{ route('subconvention') }}"><svg width="20px" height="20px"
                     ...
                     <path
                         ...
                         fill="#90A4AE" />
                 </svg><span>Subconvention Registration </span></a>
         </li>

                ...
                <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">
                    ...
                    <form method="POST" action="{{ route('books.update', $book) }}" enctype="multipart/form-data">
                        ...
                        <div class="p-10 space-y-7">
                            <div class="line">
                                <input class="line__input" id="title" namechor="title" type="text"
                                    onkeyup="this.setAttribute('value', this.value);" value="{{ $book->title }}"
                                    autocomplete="off">
                            ...
                            <div class="line">
                                <input class="line__input" id="author" name="author" type="text"
                                    onkeyup="this.setAttribute('value', this.value);" value="{{ $book->author }}"
                                    autocomplete="off">

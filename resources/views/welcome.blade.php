                        ...
                        @foreach ($poststories as $poststory)
                            <a href="{{ route('posts.show', $poststory) }}">
                                <div class="single_story">
                                    <img src="{{ asset('storage/' . $poststory->images->first()->path) }}"
                                        alt="{{ $poststory->title }}" title="{{ $poststory->title }}">
                            ...
                            <div class="flex space-x-3">
                                @auth
                                    ...
                                    <input placeholder="What's Your Mind? {{ auth()->user()->lastname }}!"
                                        class="flex-1 h-10 px-6 bg-blue-100 rounded-full hover:bg-blue-200">
                                @endauth
                                @guest
                    ...
                    @foreach ($user_fellowship_posts as $post)
                        <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                            <div class="flex justify-between items-center lg:p-4 p-2.5">
                                <div class="flex items-center flex-1 space-x-4">
                                    <a href="#">
                                        <img src="{{ $post->user->profile_photo_url }}"
                                            class="w-10 h-10 bg-blue-200 border border-white rounded-full">
                                    </a>
                                    <div class="flex-1 font-semibold capitalize">
                                        <a href="{{ route('posts.show', $post) }}"
                                            class="text-black blue:text-blue-100">{{ $post->user->name }} </a>
                                        <div class="text-xs">
                                             {{ $post->created_at->diffForHumans() }} <ion-icon name="people">
                                            </ion-icon>
                                        </div>
                                    </div>
                                </div>
                                <div>
                                    <a href="#"> <i
                                            class="p-2 -mr-1 text-2xl transition rounded-full icon-feather-more-horizontal hover:bg-blue-200 blue:hover:bg-blue-700"></i>
                                    </a>
                                    <div class="hidden w-56 p-2 mx-auto mt-12 text-base text-blue-500 bg-white border border-blue-100 rounded-md shadow-md blue:bg-blue-900 blue:text-blue-100 blue:border-blue-700"
                                        ...
                                        <ul class="space-y-1">
                                            <li>
                                                <div class="fb-share-button"
                                                    ...
                                                    data-layout="button" data-size="small"><a target="_blank"
                                                        ...
                                                        class="flex items-center px-3 py-2 rounded-md hover:bg-blue-200 hover:text-blue-800 blue:hover:bg-blue-800">
                                                        <i class="icon-brand-facebook-square"> </i>&nbsp; Share on
                                                        Facebook</a>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="whatsapp://send?text={{ route('posts.show', $post) }}"
                                                    data-action="share/whatsapp/share"><i
                                                        class="icon-brand-whatsapp-square"> </i> &nbsp; Share on
                                                    WhatsApp</a>
                                            </li>
                                        </ul>
                            ...
                            <div class="p-5 pt-0 border-b blue:border-blue-700">
                                {{ Str::limit($post->title, 100) }} <a class="text-sm text-blue-500 mt-0.5"
                                ...
                                <div class="flex space-x-4 lg:font-bold">
                                                ...
                                                <a href="#" class="flex items-center space-x-2">
                                                    <div class="p-2 rounded-full text-blue lg:bg-blue-100 blue:bg-blue-600">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                            ...
                                                            class="blue:text-blue-100">
                                                            <path
                                                                d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                                                        </svg>
                                                    </div>
                                                    <div> <button type="submit" class="btn btn-primary">
                                                            {{ $post->likes->count() }} Like </button> </div>
                                            </form>
                                        @else
                                            <a href="#" class="flex items-center space-x-2">
                                                <div class="p-2 text-black rounded-full lg:bg-blue-100 dark:bg-blue-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                        fill="currentColor" width="22" height="22"
                                    ...
                                    @guest
                                        <form action="{{ route('posts.like', $post) }}" method="POST">
                                            @csrf
                                            <a href="#" class="flex items-center space-x-2">
                                                <div class="p-2 text-black rounded-full lg:bg-blue-100 blue:bg-blue-600">
                                                    <svg width="20px" height="20px" viewBox="0 -1 32 32" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            d="M10.4652 8.91302L10.3983 8.84448C12.0024 8.96323 13.3693 7.69379 13.3693 6.08529V3.24354C13.3693 1.45218 14.8214 0 16.6128 0H17.083C19.1341 0 20.7968 1.66271 20.7968 3.71376V8.91302H27.5425C30.2544 8.91302 32.3377 11.315 31.9541 13.9998L30.4386 24.6084C30.0204 27.5357 27.5133 29.7101 24.5563 29.7101H7.42725V8.91302H10.4652Z"
                                                            fill="url(#paint0_radial_103_1511)" />
                                                        <path
                                                            d="M0 11.884V26.739C0 28.3799 1.33017 29.71 2.97101 29.71H10.3985V8.91296H2.97101C1.33017 8.91296 0 10.2431 0 11.884Z"
                                                            fill="url(#paint1_linear_103_1511)" />
                                                        <path
                                                            d="M5.19896 26.739C6.42959 26.739 7.42721 25.7414 7.42721 24.5107C7.42721 23.2801 6.42959 22.2825 5.19896 22.2825C3.96833 22.2825 2.9707 23.2801 2.9707 24.5107C2.9707 25.7414 3.96833 26.739 5.19896 26.739Z"
                                                            fill="white" />
                                                        <defs>
                                                            <radialGradient id="paint0_radial_103_1511" cx="0"
                                                                cy="0" r="1" gradientUnits="userSpaceOnUse"
                                                                gradientTransform="translate(13.9501 9.55395) rotate(56.8531) scale(21.7342 17.9758)">
                                                                <stop stop-color="#FADE6C" />
                                                                <stop offset="0.327145" stop-color="#FED715" />
                                                                <stop offset="1" stop-color="#FC9900" />
                                                            </radialGradient>
                                                            <linearGradient id="paint1_linear_103_1511" x1="5.19926"
                                                                y1="8.91296" x2="5.19926" y2="29.71"
                                        ...
                                        <a href="whatsapp://send?text={{ route('posts.show', $post) }}"
                                            ...
                                            <div class="p-2 text-black rounded-full lg:bg-blue-100 dark:bg-blue-600">
                                                <svg width="20px" height="20px" viewBox="-1.5 0 259 259" version="1.1"
                                                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="w-full lg:w-72">
                    <a href="#">
                        <div class="px-4 py-3 mb-5 bg-white rounded-md shadow">
                            <h3 class="mb-1 font-semibold text-line-through"> Daily Bible Verse </h3>
                            <div class="flex px-2 py-2 -mx-2 duration-300 rounded-md hover:bg-blue-50">
                                <img src="{{ asset('assets/images/icons/bible-icon.png') }}" class="mr-3 w-9 h-9"
                                    alt="">
                    ...
                    <div class="px-4 py-3 mb-5 bg-white rounded-md shadow">
                        <h3 class="mb-1 font-semibold text-line-through"> Daily Prayer Chant </h3>
                        @foreach ($sideprayers as $sideprayer)
                            <div class="flex px-2 py-2 -mx-2 duration-300 rounded-md hover:bg-blue-50">
                                <img src="{{ asset('assets/images/icons/dua-hands.png') }}" class="mr-3 w-9 h-9"
                                    alt="">
                                <p class="leading-6 line-clamp-2">
                    ...
                    <br>
                    <h3 class="mb-1 font-semibold text-line-through"> Suggested Audios - <a
                            href="{{ route('audios.index') }}" class="hover:text-blue-600 hover:underline"> See All </a>
                    </h3>
                    @foreach ($sideaudios as $aud)
                        <div class="flex items-center p-2 -mx-2 space-x-4 rounded-md hover:bg-blue-50">
                            <a href="#" href="#" iv
                                class="relative flex-shrink-0 w-12 h-12 overflow-hidden rounded-full">
                                <img src="{{ asset($aud->image) }}" class="absolute inset-0 w-full h-full "
                                    alt="{{ $aud->title }}">
                            </a>

                            <div class="flex-1">
                                <a href="#"
                                    class="mt-1 text-base font-semibold leading-6 capitalize line-clamp-1">{{ $aud->title }}
                                </a>
                    ...
                    @endforeach
                    <div class="px-4 py-3 mb-5 bg-white rounded-md shadow">
                        <h3 class="mb-1 font-semibold text-line-through"> Suggested Products </h3>
                        @foreach ($sideproducts as $sideproduct)
                            <a href="{{ route('products.show', $sideproduct) }}">
                                <div class="flex px-2 py-2 -mx-2 duration-300 rounded-md hover:bg-blue-50">
                                    ...
                                    <p class="mt-1 leading-6 line-clamp-2"> <strong> {{ $sideproduct->name }} </strong>
                                        for
                        ...
                        <br>
                        <hr>
                        <a href="{{ route('products.index') }}" class="hover:text-blue-600 hover:underline"> See All
                        </a>
                    </div>
                    <div class="px-4 py-3 mb-5 bg-white rounded-md shadow">
                        <h3 class="mb-1 font-semibold text-line-through"> Suggested Vacancies </h3>
                        @foreach ($sidejobs as $sidejob)
                            <a href="{{ route('vacancies.show', $sidejob) }}">
                                <div class="flex px-2 py-2 -mx-2 duration-300 rounded-md hover:bg-blue-50">
                                    <img src="{{ asset($sidejob->image) }}" class="mr-3 w-9 h-9" alt="">
                                    <p class="mt-2 leading-6 line-clamp-2"> <strong> {{ $sidejob->position }} </strong>
                                        Salary of
                        ...
                        <br>
                        <hr>
                        <a href="{{ route('vacancies.index') }}" class="hover:text-blue-600 hover:underline"> See All
                        </a>
                    </div>
                </div>
            </div>

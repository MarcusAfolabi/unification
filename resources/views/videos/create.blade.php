                        ...
                        <div class="p-10 space-y-7">
                            <div class="line">
                                <input class="line__input" id="title" name="title" type="text"
                                    ...
                                    autocomplete="off">
                                <span for="title" class="line__placeholder"> Video Title </span>
                            </div>
                            @error('title')
                            ...
                            @error('image')
                                <p style="color: red; ">{{ $message }} </p>
                            @enderror
                            <label>Video Link *Must be similar to https://www.youtube.com/embed/o6-4tWKxFYk</label>  

                            <div class="line">
                                <input class="line__input" id="video_url" name="url" type="url"
                                    onkeyup="this.setAttribute('value', this.value);" value="{{ old('url') }}" autocomplete="off">
                                <span for="video_url" class="line__placeholder">https://www.youtube.com</span>
                            </div>
                            @error('video_url')
                                <p style="color: red; ">{{ $message }} </p>
                            @enderror
                            ...
                            <div class="form-group">
                                <textarea name="content" id="content" placeholder="Video Detail" rows="5" cols="30">

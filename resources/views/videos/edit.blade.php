                    ...
                    <form method="POST" action="{{ route('videos.update', $video) }}" enctype="multipart/form-data">
                       @method('PUT')
                        ...
                        <div class="p-10 space-y-7">
                            <div class="line">
                                <input class="line__input" id="title" name="title" type="text"
                                    onkeyup="this.setAttribute('value', this.value);" value="{{ $video->title }}"
                                    autocomplete="off">
                            ...
                            <div class="line">
                                <input class="line__input" id="url" name="url" type="url"
                                    onkeyup="this.setAttribute('value', this.value);" value="{{ $video->url }}" autocomplete="off">
                                <span for="video_url" class="line__placeholder"> URL </span>
                            </div>
                            @error('url')
                                <p style="color: red; ">{{ $message }} </p>
                            @enderror
                        ...
                        <div class="border-t flex justify-between lg:space-x-10 p-7 bg-gray-50 rounded-b-md">
                            ...
                            <a href="{{ route('videos.index') }}" <button class="button dark" >BACK</button></a>
                        </div>
